...
namespace ES3Editor
{
	public class ToolsWindow : SubWindow
	{
        ...
        [UnityEditor.MenuItem("Tools/Easy Save 3/Open Persistent Data Path", false, 200)]
        private static void OpenPersistentDataPath()
        {
            EditorUtility.RevealInFinder(Application.persistentDataPath);
        }

        [UnityEditor.MenuItem("Tools/Easy Save 3/Clear Persistent Data Path", false, 200)]
        ...
        [UnityEditor.MenuItem("Tools/Easy Save 3/Clear PlayerPrefs", false, 200)]
