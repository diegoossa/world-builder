...
public class ES3ReferenceMgrEditor : Editor
{
    ...
    [UnityEditor.MenuItem("GameObject/Easy Save 3/Add Reference(s) to Manager", false, 33)]
    [UnityEditor.MenuItem("Assets/Easy Save 3/Add Reference(s) to Manager", false, 33)]
